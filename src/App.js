...
class App extends Component {
    ...
    render() {
        ...
        <Modal isOpen={this.state.modalEditar}>
                ...
                <ModalBody>
                  <div className="form-group">
                    <label>Canal ({this.state.form.id}): </label>
                    <br />
                    <input type="text" className="form-control" name="canal" onChange={this.handleChange} value={this.state.form && this.state.form.title}/>
                    <br />
                    <label>País: </label>
                    <br />
                    <input type="text" className="form-control" name="pais" onChange={this.handleChange} value={this.state.form && this.state.form.text}/>
                    <br />
                    <label>Idioma: </label>
                    <br />
                    <input type="text" className="form-control" name="idioma" onChange={this.handleChange} value={this.state.form && this.state.form.price}/>
                    <br />
                    <label>Suscriptores: </label>
                    <br />
                    <input type="text" className="form-control" name="suscriptores" onChange={this.handleChange} value={this.state.form && this.state.form.discount}/>
                    <br />
                  </div>
                </ModalBody>
                <ModalFooter>
